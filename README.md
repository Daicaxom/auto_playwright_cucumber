...
- **Cucumber Reports**: HTML and JSON reports in `results/`
- **Screenshots**: Automatic capture on failure in `results/screenshots/`
- **Videos**: Optional video recording in `results/videos/`
- **Traces**: Playwright traces in `results/traces/`
- **Coverage**: Jest coverage reports in `results/coverage/`
